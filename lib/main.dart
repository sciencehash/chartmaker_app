...
class _AppState extends State<App> {
  ...
  Future<FirebaseApp> _initialization() async {
    if (kIsWeb) {
      ...
      await Hive.openBox('userDocumentData');
      await Hive.openBox('staticDataCache');
    } else {
      ...
      await Hive.openBox('userDocumentData', path: appDocPath);
      await Hive.openBox('staticDataCache', path: appDocPath);
    }
